...
for sub=subs
    for idx=idxs
        ...
        for run = runs
            ...
            subplot 413
            plot(1:17, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrPearson_CompPatt.(subjects{sub})(1:17, run), 'color', [0.9290 0.6940 0.1250])
            hold on
            plot(1:17, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrPearson_PattComp.(subjects{sub})(1:17, run), 'color', [0.4660 0.6740 0.1880])
            ...
            subplot 414
            plot(1:17, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrSpearman_CompPatt.(subjects{sub})(1:17, run), 'color', [0.9290 0.6940 0.1250])
            hold on
            plot(1:17, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrSpearman_PattComp.(subjects{sub})(1:17, run), 'color', [0.4660 0.6740 0.1880])
            title(sprintf('Correlation between %s and %s', string(ROIs_clean(comb(idx,1))), string(ROIs_clean(comb(idx,2)))));
            ...
            if lastEffect_CompPatt>=5 && lastEffect_CompPatt<=17
                if effect_CompPatt == 1 %Negative Hysteresis
                    ...
                    hold on
                    plot(effectBlock_CompPatt, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrPearson_CompPatt.(subjects{sub})(effectBlock_CompPatt,run), '-vb')
                    hold off
                    
                    subplot 414
                    %Spearman Correlation ROI1 ROI2
                    hold on
                    plot(effectBlock_CompPatt, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrSpearman_CompPatt.(subjects{sub})(effectBlock_CompPatt,run), '-vb')
                    hold off
                ...
                elseif effect_CompPatt == 2 %Positive Hysteresis
                    ...
                    %Pearson Correlation ROI1 ROI2
                    hold on
                    plot(effectBlock_CompPatt, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrPearson_CompPatt.(subjects{sub})(effectBlock_CompPatt,run), '-+b')
                    hold off
                    
                    subplot 414
                    %Spearman Correlation ROI1 ROI2
                    hold on
                    plot(effectBlock_CompPatt, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrSpearman_CompPatt.(subjects{sub})(effectBlock_CompPatt,run), '-+b')
                    hold off
                ...
                elseif effect_CompPatt == 3 
                    ...
                    %Pearson Correlation ROI1 ROI2
                    hold on
                    plot(effectBlock_CompPatt, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrPearson_CompPatt.(subjects{sub})(effectBlock_CompPatt,run), '-ob')
                    hold off
                    
                    subplot 414
                    %Pearson Correlation ROI1 ROI2
                    hold on
                    plot(effectBlock_CompPatt, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrSpearman_CompPatt.(subjects{sub})(effectBlock_CompPatt,run), '-ob')
                    hold off
                elseif effect_CompPatt == 4
                    ...
                    %Pearson Correlation ROI1 ROI2
                    hold on
                    plot(effectBlock_CompPatt, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrPearson_CompPatt.(subjects{sub})(effectBlock_CompPatt,run), '-sb')
                    hold off
                    
                    subplot 414
                    %Pearson Correlation ROI1 ROI2
                    hold on
                    plot(effectBlock_CompPatt, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrSpearman_CompPatt.(subjects{sub})(effectBlock_CompPatt,run), '-sb')
                    hold off
            ...
            if lastEffect_PattComp>=5 && lastEffect_PattComp<=17
                if effect_PattComp == 1 %Negative Hysteresis
                    ...
                    %Pearson Correlation ROI1 ROI2
                    hold on
                    plot(effectBlock_PattComp, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrPearson_PattComp.(subjects{sub})(effectBlock_PattComp,run), '-vr')
                    hold off; hold off

                    subplot 414                   
                    hold on
                    plot(effectBlock_PattComp, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrSpearman_PattComp.(subjects{sub})(effectBlock_PattComp,run), '-vr')
                    hold off; hold off
                ...
                elseif effect_PattComp == 2 %Positive Hysteresis
                    ...
                    %Pearson Correlation ROI1 ROI2
                    hold on
                    plot(effectBlock_PattComp, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrPearson_PattComp.(subjects{sub})(effectBlock_PattComp,run), '-+r')
                    hold off; hold off

                    subplot 414
                    %Pearson Correlation ROI1 ROI2
                    hold on
                    plot(effectBlock_PattComp, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrSpearman_PattComp.(subjects{sub})(effectBlock_PattComp,run), '-+r')
                    hold off; hold off
                ...
                elseif effect_PattComp == 3 
                    ...
                    %Pearson Correlation ROI1 ROI2
                    hold on
                    plot(effectBlock_PattComp, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrPearson_PattComp.(subjects{sub})(effectBlock_PattComp,run), '-or')
                    hold off; hold off

                    subplot 414
                    %Pearson Correlation ROI1 ROI2
                    hold on
                    plot(effectBlock_PattComp, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrSpearman_PattComp.(subjects{sub})(effectBlock_PattComp,run), '-or')
                    hold off; hold off
                ...
                elseif effect_PattComp == 4
                    ...
                    %Pearson Correlation ROI1 ROI2
                    hold on
                    plot(effectBlock_PattComp, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrPearson_PattComp.(subjects{sub})(effectBlock_PattComp,run), '-sr')
                    hold off; hold off

                    subplot 414
                    %Spearman Correlation ROI1 ROI2
                    hold on
                    plot(effectBlock_PattComp, blockmetrics.(ROIs{comb(idx,1)}).(ROIs{comb(idx,2)}).corrSpearman_PattComp.(subjects{sub})(effectBlock_PattComp,run), '-sr')
                    hold off; hold off
                end
            end
