    ...
    for run = 1:nRuns
        ...
        for rr = 1:nROIs
            ...
            for trial = 1:nTrials
                ...
                xx_CompPatt = (volmin_CompPatt-nStatic):(volmin_CompPatt+nVols+nStatic); % block indexes
                ...
                xx_PattComp = (volmin_PattComp-nStatic):(volmin_PattComp+nVols+nStatic);
...
save('new_trialvolumes_plus_static.mat', 'trialvol');
...
save('correlationTCs_wdSz10.mat', 'correlationTCs')
