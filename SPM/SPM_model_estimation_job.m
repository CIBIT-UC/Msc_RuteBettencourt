%-----------------------------------------------------------------------
% Job saved on 15-Jul-2022 17:06:13 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
...
for sub = 4:25
    ...
    matlabbatch{1}.spm.stats.fmri_spec.dir = {sprintf('/DATAPOOL/VPHYSTERESIS/BIDS-VP-HYSTERESIS/derivatives/spm_main/sub-%02d/1st_level', sub)}; %Directory for first-level analysis
...
%% Create cell with all volumes from run 1
    ...
    for vols = 1:266
        img_run1{idx1,1} = sprintf('/DATAPOOL/VPHYSTERESIS/BIDS-VP-HYSTERESIS/derivatives/spm_main/sub-%02d/func/swasub-%02d_task-main_run-01_bold.nii,%d', sub, sub, vols);
        idx1 = idx1+1;
    end
    
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).scans = img_run1;
%% Conditions - discard run1
    Discard_run1 = load(sprintf('/DATAPOOL/VPHYSTERESIS/BIDS-VP-HYSTERESIS/derivatives/spm_main/sub-%02d/func/Discard_run-01.txt', sub));
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(1).name = 'Discard';
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(1).onset = Discard_run1(:,1);
...
%% Conditions - ComPatt run1
    CompPatt_run1 = load(sprintf('/DATAPOOL/VPHYSTERESIS/BIDS-VP-HYSTERESIS/derivatives/spm_main/sub-%02d/func/CompPatt_run-01.txt', sub));
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).name = 'CompPatt';
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).onset = CompPatt_run1(:,1);
...
%% Conditions - PattComp run1
    PattComp_run1 = load(sprintf('/DATAPOOL/VPHYSTERESIS/BIDS-VP-HYSTERESIS/derivatives/spm_main/sub-%02d/func/PattComp_run-01.txt', sub));
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).name = 'PattComp';
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).onset = PattComp_run1(:,1);
...
%% Conditions - Static run1
    Static_run1 = load(sprintf('/DATAPOOL/VPHYSTERESIS/BIDS-VP-HYSTERESIS/derivatives/spm_main/sub-%02d/func/Static_run-01.txt', sub));
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).name = 'Static';
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).onset = Static_run1(:,1);
...
%% Conditions - MAE run1
    MAE_run1 = load(sprintf('/DATAPOOL/VPHYSTERESIS/BIDS-VP-HYSTERESIS/derivatives/spm_main/sub-%02d/func/MAE_run-01.txt', sub));
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(5).name = 'MAE';
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(5).onset = MAE_run1(:,1);
...
%%
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).multi_reg = {sprintf('/DATAPOOL/VPHYSTERESIS/BIDS-VP-HYSTERESIS/derivatives/spm_main/sub-%02d/func/rp_sub-%02d_task-main_run-01_bold.txt', sub, sub)};
