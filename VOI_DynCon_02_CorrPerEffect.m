...
for cc = 1:nCombinations
    ...
    for ee = 1:nEffects
        ...
        corrPerEffect.(effects{ee}).(ROI_clean{comb(cc,1)}).(ROI_clean{comb(cc,2)}).CompPatt.Pearson = zeros(nRunsPerEffect_CompPatt(ee),11); 
        corrPerEffect.(effects{ee}).(ROI_clean{comb(cc,1)}).(ROI_clean{comb(cc,2)}).PattComp.Pearson = zeros(nRunsPerEffect_PattComp(ee),11); 
        corrPerEffect.(effects{ee}).(ROI_clean{comb(cc,1)}).(ROI_clean{comb(cc,2)}).CompPatt.Spearman = zeros(nRunsPerEffect_CompPatt(ee),11); 
        corrPerEffect.(effects{ee}).(ROI_clean{comb(cc,1)}).(ROI_clean{comb(cc,2)}).PattComp.Spearman = zeros(nRunsPerEffect_PattComp(ee),11); 
